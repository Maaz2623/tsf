...
const HomePage = () => {
  return (
    <div className="h-screen relative">
      ...
      >
        <Navbar />
        <div className="z-50 py-20 px-20">
          <h1 className="text-center justify-center flex flex-col space-y-4 text-5xl text-white">
            Welcome to <br />
            <span className={`${exo_2.className} font-bold text-amber-500`}>
              THE STUDENT FORUM
            </span>
